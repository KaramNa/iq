                    ...
                    <div style="width: 700px;" class="mx-auto py-8 d-flex align-items-center justify-content-center">
                        <div class="text-center col-12 p-0 mx-auto">
                            <div class="col-12 px-0 row d-flex justify-content-between ">
                                <div class="col-12 py-5 rounded-2 text-center"
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light bg-light">
                            <div class="container-fluid p-0">
                                <div
                                    ...
                                    <div class="navbar-brand navbar-toggler  font-2 px-3 col-auto"
                                         data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent"
                                         aria-controls="navbarSupportedContent" aria-expanded="false"
                                         aria-label="Toggle navigation" style="color: inherit;">لوحة التحكم
                                    </div>
                                    <button class="navbar-toggler d-flex col-auto" style="box-shadow:none;"

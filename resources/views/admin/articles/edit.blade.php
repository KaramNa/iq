        ...
        <div class="col-12 col-lg-12 p-0 ">
            <form id="validate-form" class="row" enctype="multipart/form-data" method="POST"
                                        ...
                                        <div class="col-12 p-2">
                                            ...
                                            <div class="col-12 pt-3">
                                                <input
                                                    ...
                                                    name="{{ $key }}[title]"
                                                    class="form-control"
                                                    value="{{ old($key . '.title', $article->translate($key)?->title) }}"
                                        ...
                                        <div class="col-12 p-2"
                                            ...
                                            <div class="col-12 pt-3">
                                                <textarea id="{{ $key }}[description]" name="{{ $key }}[description]"
                                                    ...
                                                    {{ old($key . '.description', $article->translate($key)?->description) }}
                                        ...
                                        <div class="col-12 p-2">
                                            ...
                                            <div class="col-12 pt-3">
                                                <input type="text"
                                                       ...
                                                       name="{{ $key }}[slug]"
                                                       class="form-control"
                                                       value="{{ old($key . '.slug', $article->translate($key)?->slug) }}"
                                                       style="direction: {{ $key == 'ar' ? 'rtl' : 'ltr' }}"
                                                >
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 p-2">
                                            ...
                                            <div class="col-12 pt-3">
                                                <textarea id="{{ $key }}[meta_description]"
                                                          ...
                                                          class="form-control"
                                                          style="direction: {{ $key == 'ar' ? 'rtl' : 'ltr' }}"
                                                >{{ old($key . '.meta_description', $article->translate($key)?->meta_description) }}</textarea>
                                            </div>
                                        </div>
                                ...
                                >
                                    ...
                                    @foreach($categories as $category)
                                        <option value="{{$category->id}}"
                                            @selected(in_array($category->id, old('category_id', $article->categories->pluck('id')->toArray()) ?? []))
                                        >
                                            {{$category->title}}
                                        </option>
                                    @endforeach
                        ...
                        <div class="col-12 p-2">
                            ...
                            <div class="col-12 pt-3">
                                ...
                                >
                                    @foreach($tags as $tag)
                                        <option value="{{$tag->id}}"
                                            @selected(in_array($tag->id, old('tag_id', $article->tags->pluck('id')->toArray()) ?? []))
                                        >
                                            {{$tag->name}}
                                        </option>
                                    @endforeach
                        ...
                        <div class="col-12 p-2">
                            ...
                            <div class="col-12 pt-3">
                                <select class="form-control" id="is_featured" name="is_featured">
                                    <option @selected(old('is_featured', $article->is_featured) == 0 ) value="0">
                                        @lang('No')
                                    </option>
                                    <option @selected(old('is_featured', $article->is_featured) == 1 ) value="1">
                                        @lang('Yes')
                                    </option>
                                </select>
                            </div>
                ...
                <div class="col-12 p-3">
                    ...
                    <button class="btn btn-danger mx-5" id="submitEvaluation"
                            name="draft">@lang('article.draft')</button>

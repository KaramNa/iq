@extends('layouts.admin' ,['page_title' => __('admin.add_role')])
@section('content')
                                        ...
                                        <td style="width: 56px;">
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox"
                                                       ...
                                                       @if(isset($role)&&$role->hasPermissionTo($permission->table.'-create')) checked
                                        ...
                                        <td style="width: 56px;">
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox"
                                                       ...
                                                       @if(isset($role)&&$role->hasPermissionTo($permission->table.'-read')) checked
                                                       @endif name="permissions[]">
                                            </div>
                                        </td>
                                    @else
                                        ...
                                        <td style="width: 56px;">
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox"
                                                       ...
                                                       @if(isset($role)&&$role->hasPermissionTo($permission->table.'-update')) checked
                                                       @endif name="permissions[]">
                                            </div>
                                        </td>
                                    @else
                                        ...
                                        <td style="width: 56px;">
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox"
                                                       ...
                                                       @if(isset($role)&&$role->hasPermissionTo($permission->table.'-delete')) checked
                                                       @endif name="permissions[]">
                                            </div>
                                        </td>
                                    @else

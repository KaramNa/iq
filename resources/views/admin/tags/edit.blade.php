@extends('layouts.admin' ,['page_title' => __('admin.edit_tag')])
@section('content')
<div class="col-12 p-3">
    <div class="col-12 col-lg-12 p-0 ">
        <form id="validate-form" class="row" enctype="multipart/form-data" method="POST" action="{{route('admin.tags.update',$tag->id)}}">
            @csrf
            @method("PUT")

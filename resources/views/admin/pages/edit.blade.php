@extends('layouts.admin' ,['page_title' => __('admin.edit_page')])
@section('content')
                ...
                <div class="col-12 col-lg-8 p-0 main-box">
                    <div class="col-12 px-0">
                        <div class="col-12 px-3 py-3">
                            <span class="fas fa-info-circle"></span> @lang('admin.edit_page')
                        </div>
                    ...
                    <div class="col-12 p-3 row">
                                        ...
                                        <div class="col-12 p-2">
                                            ...
                                            <div class="col-12 pt-3">
                                                <input
                                                    ...
                                                    name="{{ $key }}[title]"
                                                    class="form-control"
                                                    value="{{ old($key . '.title', $page->translate($key)?->title) }}"
                                        ...
                                        <div class="col-12 p-2"
                                            ...
                                            <div class="col-12 pt-3">
                                                <textarea id="{{ $key }}[description]" name="{{ $key }}[description]"
                                                    ...
                                                    {{ old($key . '.description', $page->translate($key)?->description) }}
                                        ...
                                        <div class="col-12 p-2">
                                            ...
                                            <div class="col-12 pt-3">
                                                <input type="text"
                                                       ...
                                                       name="{{ $key }}[slug]"
                                                       class="form-control"
                                                       value="{{ old($key . '.slug', $page->translate($key)?->slug) }}"
                                                       style="direction: {{ $key == 'ar' ? 'rtl' : 'ltr' }}"
                                                >
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 p-2">
                                            ...
                                            <div class="col-12 pt-3">
                                                <textarea id="{{ $key }}[meta_description]"
                                                          ...
                                                          class="form-control"
                                                          style="direction: {{ $key == 'ar' ? 'rtl' : 'ltr' }}"
                                                >{{ old($key . '.meta_description', $page->translate($key)?->meta_description) }}</textarea>
                                            </div>
                                        </div>
                        ...
                        <div class="col-12 col-lg-6 p-2">
                            ...
                            <div class="col-12 pt-3">
                                <img src="{{$page->image()}}" style="width:100px">
                            </div>
                        </div>
                        <div class="col-12 p-2">
                            <div class="col-12">
                            ...
                            <div class="col-12 pt-3">
                                <select class="form-control" name="removable">
                                    <option @selected(old('removable', $page->removable) == 1) value="1">@lang('Yes')</option>
                                    <option @selected(old('removable', $page->removable) == 0) value="0">@lang('No')</option>
                                </select>
                            </div>
                        </div>

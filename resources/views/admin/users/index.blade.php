@extends('layouts.admin', ['page_title' => __('admin.users')])
@section('content')
		...
		<div class="col-12 px-0">
			<div class="col-12 p-0 row">
				<div class="col-12 col-lg-4 py-3 px-3">
					<span class="fas fa-users"></span>	@lang('admin.users')
				</div>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<span class="btn btn-outline-primary btn-sm font-small mx-1">
								<span class="fal fa-key "></span> @lang('admin.permissions')
							</span>
							</a>
							@endcan

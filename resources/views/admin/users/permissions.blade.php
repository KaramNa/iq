@extends('layouts.admin', ['page_title' => __('admin.permissions')])
@section('content')
                                        ...
                                        <td style="width: 56px;">
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox"
                                                       ...
                                                       @if($user->hasPermission($permission->table.'-create')) checked
                                        ...
                                        <td style="width: 56px;">
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox"
                                                       ...
                                                       @if($user->hasPermission($permission->table.'-read')) checked
                                                       @endif name="permissions[]">
                                            </div>
                                        </td>
                                    @else
                                        ...
                                        <td style="width: 56px;">
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox"
                                                       ...
                                                       @if($user->hasPermission($permission->table.'-update')) checked
                                                       @endif name="permissions[]">
                                            </div>
                                        </td>
                                    @else
                                        ...
                                        <td style="width: 56px;">
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox"
                                                       ...
                                                       @if($user->hasPermission($permission->table.'-delete')) checked
                                                       @endif name="permissions[]">
                                            </div>
                                        </td>
                                    @else

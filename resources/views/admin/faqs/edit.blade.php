@extends('layouts.admin', ['page_title' => __('admin.edit_faq')])
@section('content')
                                    ...
                                    <div class="col-12 p-2">
                                        ...
                                        <div class="col-12 pt-3">
                                            <input
                                                ...
                                                name="{{ $key }}[question]"
                                                class="form-control"
                                                value="{{ old($key . '.question', $faq->translate($key)->question) }}"
                                    ...
                                    <div class="col-12 p-2">
                                        ...
                                        <div class="col-12 pt-3">
                                                <textarea id="{{ $key }}[answer]"
                                                          ...
                                                          style="min-height:150px; direction: {{ $key == 'ar' ? 'rtl' : 'ltr' }}">{{old('answer', $faq->translate($key)->answer)}}</textarea>
                                        </div>
                                    </div>
                                    @error("{$key}.answer")
                                    <div class="text-danger">

                    ...
                    <div class="col-12 p-2 p-lg-3 rounded-2">
                        ...
                        <div class="col-12 p-4 card-body">
                            ...
                            <ul class="post-meta mb-5">
                                <li class="post-date font-1">
                                    <i class="fal fa-calendar-alt"></i>
                                    <span> {{\Carbon::parse($article->created_at)->diffForHumans()}}</span>
                                </li>
                                {{--                                <li class="post-author font-1">--}}
                                {{--                                    <a href="{{route('blog',['user_id'=>$article->user->id])}}" class="font-1">--}}
                                ...
                                @if($article->comments_count!=0)
                                    <li class="post-comments"><a href="#comments"><i
                                                class="fal fa-comment"></i> {{$article->comments_count}}
                                            <span> تعليقات</span></a></li>
                                @endif
                                @if($article->views!=0)
                                    <li class="post-comments"><a href="#comments">
                                            <i class="fas fa-fa-thin fa-eyes"></i>
                                            {{$article->views}}
                            ...
                            <div class="col-12 p-0">
                                @if($article->comments_count)
                                    <hr/>
                                    <div id="comments">
                                        <h3 class="mb-6">{{$article->comments_count}} @lang('admin.comments')</h3>
                                ...
                                @endif
                                <hr/>
                                <h3 class="mb-3">@lang('Share your opinion with us')</h3>
                                <p class="mb-7">@lang('Your email will not be published.')</p>
                                <form class="comment-form" method="POST" action="{{route('comment-post')}}">
                                    ...
                                    @guest
                                        <div class="form-floating mb-4">
                                            <input type="text" class="form-control" placeholder="* name" id="c-name"
                                                   name="adder_name" required>
                                            <label for="c-name">* @lang('Your Name')</label>
                                        </div>
                                        <div class="form-floating mb-4">
                                            <input type="email" class="form-control" placeholder="* email"
                                                   id="c-email" name="adder_email" required>
                                            <label for="c-email">* @lang('Your Email')</label>
                                        </div>
                                    @endguest
                                    <div class="form-floating mb-4">
                                    ...
                                    <button type="submit"
                                            class="btn btn-primary rounded-pill mb-0">@lang('admin.add_comment')</button>
                                </form>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <div class="px-2" style="width:calc(100% - 75px)">
                                                    ...
                                                    <div class="col-12 mt-1 font-small"
                                                        ...
                                                        <span class="posted-on">
                                                            <span rel="bookmark">
                                                                <span
                                                                    class="d-inline-block px-0 font-small">
                                                                    <time
                                                                        class="updated">
                                                                        {{\Carbon::parse($single_article->created_at)->diffForHumans()}}
                                                                    </time>
                                                                    <span>
                                                                    </span>
                                                                </span>

@extends('layouts.app', [
    'page_title'=>$test->translate()->title,
    'seo_meta_description'=>$test->translate()->meta_description,
    'page_image'=>$test->image('original')
    ])
        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="row shadow-lg p-5">
                    <h1 class="text-center mb-5">{{ $test->translate()->title }}</h1>
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        ...
                        <ul class="list-group mb-5" style="list-style: none;padding: 5px;">
                            <x-li-checkmark :text="$test->num_of_questions . trans(' multiple-choice questions.')"/>
                            <x-li-checkmark :text="$test->duration . trans(' minutes to complete the test.')"/>
                            <x-li-checkmark

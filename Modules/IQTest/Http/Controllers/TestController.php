...
class TestController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('iqtest::admin.tests.index', compact('tests'));
    }

    public function create()
    {
        $categories = TestCategory::orderBy('id', 'DESC')->get();
        return view('iqtest::admin.tests.create', compact('categories'));
    }
    ...
    public function edit($id)
    {
        $test = Test::find($id);
        $categories = TestCategory::orderBy('id', 'DESC')->get();
        return view('iqtest::admin.tests.edit', compact('test', 'categories'));
    }

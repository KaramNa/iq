...
class QuestionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('iqtest::admin.questions.index', compact('questions'));
    }

    public function create(Request $request)
    {
        $request->validate(['test_id' => "required|exists:tests,id"]);
        return view('iqtest::admin.questions.create');
    }
    ...
    {
        return view('iqtest::admin.questions.edit', compact('question'));
    }
